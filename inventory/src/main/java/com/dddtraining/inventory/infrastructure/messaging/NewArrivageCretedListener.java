...
//@Component
public class NewArrivageCretedListener {
    ...
    public void handleEvent(Map<String, String> mesage){
        ...
        System.out.println("Recieved message for NewArrivageCreated Event \n\n");
        ...
        this.stockApplicationService()
                .addProductArrivageToStock(new RegisterNewStockProductArrivageCommand(
                        stockId,
                       description,
