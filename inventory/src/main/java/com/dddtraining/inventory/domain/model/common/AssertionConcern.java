...
public class AssertionConcern {
    ...
    protected void assertArgumentPositif(BigDecimal aValue, String aMessage) {
        if (aValue.doubleValue() < 0) {
            throw new IllegalArgumentException(aMessage);
        }
    }
    protected void assertArgumentPositif(int aValue, String aMessage) {
        if (aValue < 0) {
            throw new IllegalArgumentException(aMessage);
        }
    }
